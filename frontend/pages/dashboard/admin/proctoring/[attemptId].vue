  ...
  <v-container fluid class="pa-6">
    ...
    <div class="d-flex align-center justify-space-between mb-6">
      <div class="d-flex align-center gap-4">
        ...
        <div>
          <h1 class="text-h4 font-weight-bold mb-1">AI Proctoring Audit Review</h1>
        ...
        <div class="apple-card pa-5 mb-6">
          ...
          <v-list density="compact" class="bg-transparent pa-0">
            ...
            <v-list-item class="px-0">
              ...
              <v-list-item-title class="font-weight-bold">{{ details?.exam_title || 'Exam' }}</v-list-item-title>
...
definePageMeta({ 
  ...
  role: ['super_admin', 'main_admin', 'lms_user', 'tutor'] 
});
